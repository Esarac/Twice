...
class TestMotorVehicle {
	...
	//Scenes
	private void setUpSceneEmptyCar() throws InvalidPlateException {//[BAD]
		motorVehicle=new Car("Jihyo", "JHO907", VehicleFuel.GASOLINE, CarType.STANDARD, 2);
	}
	
	//Tests
	@Test
	void testValidatePlate() throws InvalidPlateException {//[BAD]
		setUpSceneEmptyCar();
	...
	@Test
	void testComparePlate() throws InvalidPlateException{
		setUpSceneEmptyCar();
